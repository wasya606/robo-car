...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = HC_12_TX_Pin|HC_12_RX_Pin;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, HC_12_TX_Pin|HC_12_RX_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(SBUS_RX_GPIO_Port, SBUS_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, BLE_TX_Pin|BLE_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, MASTER_TX_Pin|MASTER_RX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, SERIAL_SERVO_TX_Pin|SERIAL_SERVO_RX_Pin);
