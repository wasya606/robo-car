...
DifferentialChassisTypeDef huge_ti4wd;
...
static void huge_ti4wd_set_motors(void* self, float rps_l, float rps_r)
{
    encoder_motor_set_speed(motors[3], rps_r);
    encoder_motor_set_speed(motors[2], rps_r);
    encoder_motor_set_speed(motors[0], -rps_l);
...
void chassis_init(void)
{
	...
	diff_chassis_object_init(&huge_ti4wd);
    huge_ti4wd.base.chassis_type = CHASSIS_TYPE_HUGE_TI4WD;
    huge_ti4wd.correction_factor = HUGE_TI4WD_CORRECITION_FACTOR;
    huge_ti4wd.wheel_diameter = HUGE_TI4WD_WHEEL_DIAMETER;
    huge_ti4wd.shaft_length = HUGE_TI4WD_SHAFT_LENGTH;
    huge_ti4wd.set_motors = huge_ti4wd_set_motors;
...
void set_chassis_type(uint8_t chassis_type)
{
    switch(chassis_type) {
		...
		case CHASSIS_TYPE_HUGE_TI4WD:
			chassis = (ChassisTypeDef*)&huge_ti4wd;
            set_motor_type(motors[0], MOTOR_TYPE_JGB528);
            set_motor_type(motors[1], MOTOR_TYPE_JGB528);
            set_motor_type(motors[2], MOTOR_TYPE_JGB528);
            set_motor_type(motors[3], MOTOR_TYPE_JGB528);
